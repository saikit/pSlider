...
$.fn.pSlider = function ( option ) {
	...
	var slider = (function() {
		...
		buildSlider = function() {
			...
			this.$rail = $('<span class="pS-rail">').data({'status': 'ready'}).appendTo($slider);
			this.$thumb = $('<span class="pS-thumb">').data({'status': 'ready'}).appendTo(this.$rail);
			this.$progressBar = $('<span class="pS-progressBar">').appendTo(this.$rail);
			this.$number = $('<span class="pS-number">').appendTo(this.$rail);
			$cap = $('<span class="pS-cap-min"></span><span class="pS-cap-max"></span>').appendTo(this.$rail);
			$arrows = $('<div class="pS-arrows">').appendTo($slider);
			this.$up = $('<span class="pS-btn pS-btn-up">+</span>').appendTo($arrows);
			this.$down = $('<span class="pS-btn pS-btn-down">&ndash;</span>').appendTo($arrows);				
		...
		initListeners = function () {
			this.$rail.click(handlers.onRailClick);
			this.$thumb.bind('mousedown touchstart click', handlers.onThumbDrag);
			this.$number.bind('touchstart mousedown select', handlers.onThumbDrag);			
			this.$up.bind('mousedown touchstart', {direction : 'up'}, handlers.onArrowClick);
			this.$down.bind('mousedown touchstart', {direction : 'down'}, handlers.onArrowClick);
		};
